...
def get_resnet50_elastic_configs_finegrained() -> Dict[str, ElasticConfig]:
    ...
    elastic_configs["classifier.1"] = ElasticConfig(
        structural_ranges={
            ...
            "out_features": create_channel_range(1000, 1000)
        },
...
def get_resnet50_elastic_configs_finegrained_cifar10() -> Dict[str, ElasticConfig]:
    elastic_configs = {}
...
ELASTIC_CONFIGS_CIFAR10 = get_resnet50_elastic_configs_finegrained_cifar10()